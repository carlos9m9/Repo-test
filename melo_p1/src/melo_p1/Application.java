 ...
 *integer. Your application should also allow the user to enter an encrypted four-digit integer and then 
 *decrypt it (by reversing the encryption scheme) to form the original number.*/
